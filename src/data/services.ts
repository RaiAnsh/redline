...
export const services: Service[] = [
  {
    ...
    seoTitle: "HVAC Installation & Repair Toronto | Furnace & AC | Redline Contracting",
    seoDescription:
      "Furnace, air conditioner, and ductwork installation and repair in Toronto and across the GTA from Redline Contracting.",
  ...
  },
  {
    ...
    seoTitle: "Plumbing Services Toronto | Drains, Water Heaters & Fixtures | Redline Contracting",
    seoDescription:
      "Plumbing services in Toronto and across the GTA: drain cleaning, water heaters, fixture installs, and leak detection.",
  ...
  },
  {
    ...
    seoTitle: "Electrical Services Toronto | Panel Upgrades & Wiring | Redline Contracting",
    seoDescription:
      "Licensed electrical services in Toronto and across the GTA: panel upgrades, wiring, lighting, and EV charger installation.",
  ...
  },
  {
    ...
    seoTitle: "Drywall Repair Toronto | Patching & Installation | Redline Contracting",
    seoDescription:
      "Drywall repair and installation in Toronto and across the GTA: patching, water damage repair, and full installs.",
  ...
  },
  {
    ...
    seoTitle: "Interior & Exterior Painting Toronto | Redline Contracting",
    seoDescription:
      "Interior and exterior painting in Toronto and across the GTA, with proper prep and a clean, even finish.",
  ...
  },
  {
    ...
    seoTitle: "Flooring Installation Toronto | Hardwood, Laminate & Tile | Redline Contracting",
    seoDescription:
      "Flooring installation in Toronto and across the GTA: hardwood, laminate, vinyl plank, and tile.",
  ...
  },
  {
    ...
    seoTitle: "Home Renovations Toronto | Kitchen, Bathroom & Basement | Redline Contracting",
    seoDescription:
      "Kitchen, bathroom, and basement renovations in Toronto and across the GTA, with every trade coordinated under one general contractor.",
  ...
  },
  {
    ...
    seoTitle: "Emergency Repair Contractor Toronto | 24/7 Response | Redline Contracting",
    seoDescription:
      "24/7 emergency repair response in Toronto and across the GTA, plumbing, electrical, and storm damage handled fast.",
